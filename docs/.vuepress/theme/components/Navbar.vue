<template>
    <header class="navbar">
        ...
        <div class="links" :style="linksWrapMaxWidth ? { 'max-width': linksWrapMaxWidth + 'px' } : {}">
            <div v-if="sublime.extraOptions && sublime.extraOptions.before" class="user-options-before">
                <component :is="sublime.extraOptions.before" />
            </div>
            <UserSettings />
            <div v-if="sublime.extraOptions && sublime.extraOptions.after" class="user-options-after">
                <component :is="sublime.extraOptions.after" />
            </div>
